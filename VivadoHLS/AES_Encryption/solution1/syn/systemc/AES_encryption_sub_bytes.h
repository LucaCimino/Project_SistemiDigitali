...
#ifndef _AES_encryption_sub_bytes_HH_
#define _AES_encryption_sub_bytes_HH_
...
struct AES_encryption_sub_bytes : public sc_module {
    ...
    // Module declarations
    AES_encryption_sub_bytes(sc_module_name name);
    SC_HAS_PROCESS(AES_encryption_sub_bytes);

    ~AES_encryption_sub_bytes();

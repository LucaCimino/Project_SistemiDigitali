...
entity AES_encryption_gmult is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of AES_encryption_gmult is 
    ...
    signal tmp_14_fu_118_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_16_fu_124_p3 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    a_assign_1_fu_132_p2 <= (tmp_14_fu_118_p2 xor ap_const_lv8_1B);
    a_assign_2_fu_138_p3 <= 
        a_assign_1_fu_132_p2 when (tmp_16_fu_124_p3(0) = '1') else 
        tmp_14_fu_118_p2;
    ...
    tmp_14_fu_118_p2 <= std_logic_vector(shift_left(unsigned(p_0_reg_75),to_integer(unsigned('0' & ap_const_lv8_1(8-1 downto 0)))));
    tmp_16_fu_124_p3 <= p_0_reg_75(7 downto 7);

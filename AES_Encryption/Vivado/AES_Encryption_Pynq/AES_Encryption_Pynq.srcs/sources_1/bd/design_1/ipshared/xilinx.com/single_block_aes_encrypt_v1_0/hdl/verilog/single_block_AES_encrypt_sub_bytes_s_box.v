...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module single_block_AES_encrypt_sub_bytes_s_box_rom (
...
initial begin
    $readmemh("./single_block_AES_encrypt_sub_bytes_s_box_rom.dat", ram0);
    $readmemh("./single_block_AES_encrypt_sub_bytes_s_box_rom.dat", ram1);
    $readmemh("./single_block_AES_encrypt_sub_bytes_s_box_rom.dat", ram2);
    $readmemh("./single_block_AES_encrypt_sub_bytes_s_box_rom.dat", ram3);
    $readmemh("./single_block_AES_encrypt_sub_bytes_s_box_rom.dat", ram4);
    $readmemh("./single_block_AES_encrypt_sub_bytes_s_box_rom.dat", ram5);
    $readmemh("./single_block_AES_encrypt_sub_bytes_s_box_rom.dat", ram6);
    $readmemh("./single_block_AES_encrypt_sub_bytes_s_box_rom.dat", ram7);
end
...
`timescale 1 ns / 1 ps
module single_block_AES_encrypt_sub_bytes_s_box(
    reset,
    clk,
    address0,
    ce0,
...
single_block_AES_encrypt_sub_bytes_s_box_rom single_block_AES_encrypt_sub_bytes_s_box_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),

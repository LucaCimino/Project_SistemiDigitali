...
module single_block_CTR_encrypt_shift_rows (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_sig_78;
wire   [1:0] tmp_10_fu_158_p1;
reg   [1:0] tmp_10_reg_248;
...
reg    ap_sig_114;
wire   [63:0] tmp_8_fu_115_p1;
wire   [63:0] tmp_2_fu_126_p1;
wire   [63:0] tmp_5_fu_171_p1;
wire   [63:0] tmp_3_fu_194_p1;
wire   [3:0] tmp_9_fu_120_p2;
wire   [3:0] s_cast_fu_131_p1;
wire   [3:0] tmp_3_cast_fu_162_p1;
wire   [3:0] tmp_4_fu_166_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond2_fu_97_p2 == 1'b0))) begin
        state_addr_1_reg_222[3 : 2] <= tmp_2_fu_126_p1[3 : 2];
        state_addr_reg_217[3 : 2] <= tmp_8_fu_115_p1[3 : 2];
...
always @ (*) begin
    if ((1'b1 == ap_sig_cseq_ST_st6_fsm_5)) begin
        state_address0 = tmp_3_fu_194_p1;
    end else if (((1'b1 == ap_sig_cseq_ST_st5_fsm_4) & ~(1'b0 == exitcond_fu_152_p2))) begin
        state_address0 = state_addr_1_reg_222;
    end else if (((1'b1 == ap_sig_cseq_ST_st5_fsm_4) & (1'b0 == exitcond_fu_152_p2))) begin
        state_address0 = tmp_5_fu_171_p1;
...
assign tmp1_fu_182_p2 = ($signed(ap_const_lv2_3) + $signed(tmp_10_reg_248));

assign tmp_10_fu_158_p1 = k_reg_82[1:0];

assign tmp_2_fu_126_p1 = tmp_9_fu_120_p2;

assign tmp_3_cast_fu_162_p1 = k_reg_82;

assign tmp_3_fu_194_p1 = tmp_7_fu_187_p3;

assign tmp_4_fu_166_p2 = (tmp_3_cast_fu_162_p1 + tmp_s_reg_212);

assign tmp_5_fu_171_p1 = tmp_4_fu_166_p2;

assign tmp_6_fu_103_p1 = indvars_iv_reg_59[1:0];

assign tmp_7_fu_187_p3 = {{tmp_6_reg_207}, {tmp1_fu_182_p2}};

assign tmp_8_fu_115_p1 = tmp_s_fu_107_p3;

assign tmp_9_fu_120_p2 = (tmp_s_fu_107_p3 | ap_const_lv4_3);
...
endmodule //single_block_CTR_encrypt_shift_rows

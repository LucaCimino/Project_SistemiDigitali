...
set id 0
set name single_block_CTR_encrypt_mux_4to1_sel2_8_1
...
set ID 1
set MemName single_block_CTR_encrypt_aes_key_expansion_key
...
set TrueReset 0
set IsROM 1
set ROMData { "01100011" "11010011" "01110001" "11100011" "01101011" "10110010" "00010010" "10000101" "11100111" "01100111" "11010010" "11111111" "00010001" "00010101" "11100011" "10101011" }
...
# Memory (RAM/ROM)  definition:
set ID 2
set MemName single_block_CTR_encrypt_aes_key_expansion_s_box
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 256
...
# Memory (RAM/ROM)  definition:
set ID 3
set MemName single_block_CTR_encrypt_aes_key_expansion_R
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 8
set AddrRange 4
...
set TrueReset 0
set IsROM 0
set ROMData { "00000010" "00000000" "00000000" "00000000" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set MaxLatency -1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename w \
    op interface \
    ports { w_address0 { O 8 vector } w_ce0 { O 1 bit } w_we0 { O 1 bit } w_d0 { O 8 vector } w_q0 { I 8 vector } w_address1 { O 8 vector } w_ce1 { O 1 bit } w_we1 { O 1 bit } w_d1 { O 8 vector } w_q1 { I 8 vector } } \
} "
} else {

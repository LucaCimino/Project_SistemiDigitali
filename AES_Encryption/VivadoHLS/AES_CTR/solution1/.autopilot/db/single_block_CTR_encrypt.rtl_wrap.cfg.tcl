...
set DataType0 [list "stream_type" "struct stream_type" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
set Port0 [list $PortName0 $Interface0 $DataType0 $Pointer0 $Dims0 $Const0 $Volatile0 $ArrayOpt0]
lappend PortList $Port0
set PortName1 "cipher"
set BitWidth1 "24"
set ArrayOpt1 ""
set Const1 "0"
set Volatile1 "0"
...
set DataType1 [list "stream_type" "struct stream_type" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]

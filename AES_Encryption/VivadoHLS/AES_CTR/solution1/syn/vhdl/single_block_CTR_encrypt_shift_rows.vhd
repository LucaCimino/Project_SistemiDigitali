...
entity single_block_CTR_encrypt_shift_rows is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of single_block_CTR_encrypt_shift_rows is 
    ...
    signal tmp_6_fu_103_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_6_reg_207 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal tmp_10_fu_158_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_10_reg_248 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal tmp_8_fu_115_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_2_fu_126_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_5_fu_171_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_3_fu_194_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_9_fu_120_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal s_cast_fu_131_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_3_cast_fu_162_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_4_fu_166_p2 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st5_fsm_4) and (ap_const_lv1_0 = exitcond_fu_152_p2))) then
                ...
                tmp_10_reg_248 <= tmp_10_fu_158_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (exitcond2_fu_97_p2 = ap_const_lv1_0))) then
                    state_addr_1_reg_222(3 downto 2) <= tmp_2_fu_126_p1(4 - 1 downto 0)(3 downto 2);
                    state_addr_reg_217(3 downto 2) <= tmp_8_fu_115_p1(4 - 1 downto 0)(3 downto 2);
    ...
    state_address0_assign_proc : process(state_addr_reg_217, state_addr_1_reg_222, ap_sig_cseq_ST_st3_fsm_2, ap_sig_cseq_ST_st5_fsm_4, exitcond_fu_152_p2, ap_sig_cseq_ST_st6_fsm_5, tmp_5_fu_171_p1, tmp_3_fu_194_p1)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st6_fsm_5)) then 
            state_address0 <= tmp_3_fu_194_p1(4 - 1 downto 0);
        elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st5_fsm_4) and not((ap_const_lv1_0 = exitcond_fu_152_p2)))) then 
            ...
            state_address0 <= tmp_5_fu_171_p1(4 - 1 downto 0);
    ...
    tmp1_fu_182_p2 <= std_logic_vector(signed(ap_const_lv2_3) + signed(tmp_10_reg_248));
    tmp_10_fu_158_p1 <= k_reg_82(2 - 1 downto 0);
    tmp_2_fu_126_p1 <= std_logic_vector(resize(unsigned(tmp_9_fu_120_p2),64));
    tmp_3_cast_fu_162_p1 <= std_logic_vector(resize(unsigned(k_reg_82),4));
    tmp_3_fu_194_p1 <= std_logic_vector(resize(unsigned(tmp_7_fu_187_p3),64));
    tmp_4_fu_166_p2 <= std_logic_vector(unsigned(tmp_3_cast_fu_162_p1) + unsigned(tmp_s_reg_212));
    tmp_5_fu_171_p1 <= std_logic_vector(resize(unsigned(tmp_4_fu_166_p2),64));
    tmp_6_fu_103_p1 <= indvars_iv_reg_59(2 - 1 downto 0);
    tmp_7_fu_187_p3 <= (tmp_6_reg_207 & tmp1_fu_182_p2);
    tmp_8_fu_115_p1 <= std_logic_vector(resize(unsigned(tmp_s_fu_107_p3),64));
    tmp_9_fu_120_p2 <= (tmp_s_fu_107_p3 or ap_const_lv4_3);
    tmp_s_fu_107_p3 <= (tmp_6_fu_103_p1 & ap_const_lv2_0);
end behav;

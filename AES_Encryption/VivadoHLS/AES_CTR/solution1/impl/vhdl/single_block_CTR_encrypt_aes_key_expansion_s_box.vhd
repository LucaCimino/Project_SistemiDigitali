...
entity single_block_CTR_encrypt_aes_key_expansion_s_box_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 8; 
...
architecture rtl of single_block_CTR_encrypt_aes_key_expansion_s_box_rom is 
...
entity single_block_CTR_encrypt_aes_key_expansion_s_box is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of single_block_CTR_encrypt_aes_key_expansion_s_box is
    component single_block_CTR_encrypt_aes_key_expansion_s_box_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    single_block_CTR_encrypt_aes_key_expansion_s_box_rom_U :  component single_block_CTR_encrypt_aes_key_expansion_s_box_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

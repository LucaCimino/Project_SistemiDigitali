...
wire   [7:0] tmp_70_fu_166_p4;
reg   [7:0] tmp_70_reg_275;
wire   [2:0] tmp_73_fu_176_p2;
reg   [2:0] tmp_73_reg_282;
...
reg    ap_sig_111;
wire   [63:0] tmp_67_fu_154_p1;
wire   [63:0] tmp_74_fu_182_p1;
wire   [63:0] tmp_76_fu_193_p1;
wire   [63:0] tmp_71_fu_198_p1;
wire   [63:0] tmp_79_fu_217_p1;
wire   [63:0] tmp_81_fu_227_p1;
wire   [63:0] tmp_84_fu_235_p1;
wire   [63:0] tmp_86_fu_245_p1;
wire   [7:0] tmp_77_fu_202_p2;
wire   [7:0] grp_fu_135_p2;
wire   [3:0] tmp_31_fu_163_p1;
wire   [1:0] tmp_fu_159_p1;
wire   [7:0] tmp_75_fu_187_p2;
wire   [3:0] tmp_s_fu_209_p3;
wire   [7:0] tmp_80_fu_222_p2;
wire  signed [3:0] tmp_83_cast3_fu_232_p1;
wire   [7:0] tmp_85_fu_240_p2;
reg   [4:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond_fu_142_p2 == 1'b0))) begin
        state_addr_12_reg_287[2 : 0] <= tmp_74_fu_182_p1[2 : 0];
        state_addr_reg_270[2 : 0] <= tmp_67_fu_154_p1[2 : 0];
        tmp_70_reg_275[7 : 2] <= tmp_70_fu_166_p4[7 : 2];
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_sig_cseq_ST_st3_fsm_2)) begin
        state_addr_13_reg_303[2 : 0] <= tmp_79_fu_217_p1[2 : 0];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_sig_cseq_ST_st4_fsm_3)) begin
        state_addr_14_reg_314 <= tmp_84_fu_235_p1;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_sig_cseq_ST_st5_fsm_4)) begin
        ...
        state_address0 = tmp_67_fu_154_p1;
    end else begin
        state_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_sig_cseq_ST_st5_fsm_4)) begin
        ...
        state_address1 = tmp_84_fu_235_p1;
    end else if ((1'b1 == ap_sig_cseq_ST_st3_fsm_2)) begin
        state_address1 = tmp_79_fu_217_p1;
    end else if ((1'b1 == ap_sig_cseq_ST_st2_fsm_1)) begin
        state_address1 = tmp_74_fu_182_p1;
    end else begin
        state_address1 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_sig_cseq_ST_st4_fsm_3)) begin
        w_address0 = tmp_81_fu_227_p1;
    end else if ((1'b1 == ap_sig_cseq_ST_st3_fsm_2)) begin
        w_address0 = tmp_71_fu_198_p1;
    end else if ((1'b1 == ap_sig_cseq_ST_st2_fsm_1)) begin
        w_address0 = tmp_76_fu_193_p1;
    end else begin
        w_address0 = 'bx;
    end
end
...
assign tmp_31_fu_163_p1 = r[3:0];

assign tmp_67_fu_154_p1 = c_reg_118;

assign tmp_70_fu_166_p4 = {{{tmp_31_fu_163_p1}, {tmp_fu_159_p1}}, {ap_const_lv2_0}};

assign tmp_71_fu_198_p1 = tmp_70_reg_275;

assign tmp_73_fu_176_p2 = (c_reg_118 ^ ap_const_lv3_4);

assign tmp_74_fu_182_p1 = tmp_73_fu_176_p2;

assign tmp_75_fu_187_p2 = (tmp_70_fu_166_p4 | ap_const_lv8_1);

assign tmp_76_fu_193_p1 = tmp_75_fu_187_p2;

assign tmp_77_fu_202_p2 = (w_q0 ^ state_q1);

assign tmp_79_fu_217_p1 = tmp_s_fu_209_p3;

assign tmp_80_fu_222_p2 = (tmp_70_reg_275 | ap_const_lv8_2);

assign tmp_81_fu_227_p1 = tmp_80_fu_222_p2;

assign tmp_83_cast3_fu_232_p1 = $signed(tmp_73_reg_282);

assign tmp_84_fu_235_p1 = $unsigned(tmp_83_cast3_fu_232_p1);

assign tmp_85_fu_240_p2 = (tmp_70_reg_275 | ap_const_lv8_3);

assign tmp_86_fu_245_p1 = tmp_85_fu_240_p2;

assign tmp_fu_159_p1 = c_reg_118[1:0];

assign tmp_s_fu_209_p3 = {{1'b1}, {c_reg_118}};

assign w_address1 = tmp_86_fu_245_p1;

always @ (posedge ap_clk) begin
    state_addr_reg_270[3] <= 1'b0;
    tmp_70_reg_275[1:0] <= 2'b00;

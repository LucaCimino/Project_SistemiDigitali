...
entity AES_encryption_aes_key_expansion_s_box_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 8; 
...
architecture rtl of AES_encryption_aes_key_expansion_s_box_rom is 
...
entity AES_encryption_aes_key_expansion_s_box is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of AES_encryption_aes_key_expansion_s_box is
    component AES_encryption_aes_key_expansion_s_box_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    AES_encryption_aes_key_expansion_s_box_rom_U :  component AES_encryption_aes_key_expansion_s_box_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

...
#ifndef _AES_encryption_shift_rows_HH_
#define _AES_encryption_shift_rows_HH_
...
struct AES_encryption_shift_rows : public sc_module {
    ...
    // Module declarations
    AES_encryption_shift_rows(sc_module_name name);
    SC_HAS_PROCESS(AES_encryption_shift_rows);

    ~AES_encryption_shift_rows();
    ...
    sc_signal< sc_lv<2> > tmp_4_fu_103_p1;
    sc_signal< sc_lv<2> > tmp_4_reg_207;
    ...
    sc_signal< sc_lv<4> > tmp_2_fu_120_p2;
    ...
    void thread_tmp_2_fu_120_p2();
    void thread_tmp_3_fu_126_p1();
    void thread_tmp_4_fu_103_p1();
